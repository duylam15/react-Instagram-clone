                ...
                <div className="flex flex-col w-full">
                    <div className="mb-2">
                        <input
                            ...
                            className={`p-2 border rounded-md text-sm w-full ${errors.email ? "border-red-500" : "border-gray-300"} focus:outline-none focus:border-black`}
                        />
                    ...
                    <div className="mb-2">
                        <input
                            ...
                            onChange={handleChange}
                            placeholder="Tên"
                            className={`p-2 border rounded-md text-sm w-full ${errors.firstName ? "border-red-500" : "border-gray-300"} focus:outline-none focus:border-black`}
                        />
                    ...
                    <div className="mb-2">
                        <input
                            ...
                            onChange={handleChange}
                            placeholder="Họ"
                            className={`p-2 border rounded-md text-sm w-full ${errors.lastName ? "border-red-500" : "border-gray-300"} focus:outline-none focus:border-black`}
                        />
                    ...
                    <div className="mb-2">
                        <input
                            ...
                            className={`p-2 border rounded-md text-sm w-full ${errors.userName ? "border-red-500" : "border-gray-300"} focus:outline-none focus:border-black`}
                        />
                    ...
                    <div className="mb-2">
                        <input
                            ...
                            onChange={handleChange}
                            className={`p-2 border rounded-md text-sm w-full ${errors.password ? "border-red-500" : "border-gray-300"} focus:outline-none focus:border-black`}
                        />
